...
**E34–E78, E80, E81: PASS (raw evidence committed). E79: FAIL — three failing cells per the raw gates (/en LCP=3301ms · /ar LCP=3836ms · /ar performance=87 score:false — the current raw, Actions run 30 [the p6 baseline dispatch, raw-only: zero product code rode it]; the run-band history: runs 25/26/27/28 recorded the same three cells at 3340/3904/87 · 3349/3888/87 · 3522/4056/85 · 3361/3911/86; run 29: 3335/3910/87), diagnosed below. The contract's DONE definition is therefore NOT met; this report is the honest close of the round per §8/N16/N24 — every number regenerates from the run's raw artifacts.**
...
| **E79 THE EXIT GATE** | **FAIL** | `prod-run/lighthouse/medians.md` (current raw = Actions run 30, the p6 baseline dispatch — raw-only, zero product code) — CLS 0.0195/0.0000 · TBT 47/46ms all PASS; **THREE failing cells per the raw gates: /en LCP=3301ms (lcp:false) · /ar LCP=3836ms (lcp:false) · /ar performance=87 (score:false, below the ≥90 gate — the LCP weight drives the AR score down; EN performance=92 passes; the run-band history: 3340/3904/87 · 3349/3888/87 · 3522/4056/85 · 3361/3911/86 · 3335/3910/87 across runs 25–29).** Every other exit-gate component green in the same dispatch: 16/16 budgets, axe 0/0, honest 404, race guard, 0 spinners, six organs, ΣΔ≤0 ledger |
