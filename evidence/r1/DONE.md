...
| **E79 THE EXIT GATE** | **FAIL** | `prod-run/lighthouse/medians.md` (current raw = Actions run 27) — CLS 0.0195/0.0000 · TBT 75/81ms all PASS; **THREE failing cells per the raw gates: /en LCP=3522ms (lcp:false) · /ar LCP=4056ms (lcp:false) · /ar performance=85 (score:false, below the ≥90 gate — the LCP weight drives the AR score down; EN performance=90 passes; runs 25/26 recorded the same three cells at 3340/3904/87 · 3349/3888/87).** Every other exit-gate component green in the same dispatch: 16/16 budgets, axe 0/0, honest 404, race guard, 0 spinners, six organs, ΣΔ≤0 ledger |
