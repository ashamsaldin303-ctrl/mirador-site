...
**E34–E78, E80, E81: PASS (raw evidence committed). E79: FAIL — three failing cells per the raw gates (/en LCP=3361ms · /ar LCP=3911ms · /ar performance=86 score:false — the current raw, the exit re-dispatch Actions run 28; runs 25/26/27 recorded the same three cells at 3340/3904/87 · 3349/3888/87 · 3522/4056/85), diagnosed below. The contract's DONE definition is therefore NOT met; this report is the honest close of the round per §8/N16/N24 — every number regenerates from the run's raw artifacts.**
...
| **E79 THE EXIT GATE** | **FAIL** | `prod-run/lighthouse/medians.md` (current raw = the exit re-dispatch, Actions run 28) — CLS 0.0195/0.0000 · TBT 87/94ms all PASS; **THREE failing cells per the raw gates: /en LCP=3361ms (lcp:false) · /ar LCP=3911ms (lcp:false) · /ar performance=86 (score:false, below the ≥90 gate — the LCP weight drives the AR score down; EN performance=91 passes; runs 25/26/27 recorded the same three cells at 3340/3904/87 · 3349/3888/87 · 3522/4056/85).** Every other exit-gate component green in the same dispatch: 16/16 budgets, axe 0/0, honest 404, race guard, 0 spinners, six organs, ΣΔ≤0 ledger |
