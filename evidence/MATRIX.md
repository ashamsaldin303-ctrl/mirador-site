...
Generated from executed runs 2026-09-23T17:17:48.364Z — every row cites its run's output path (N20); the path self-check (E83) proves every citation resolves.
