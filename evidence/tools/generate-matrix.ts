...
console.log(`MATRIX.md written (${R.length} rows) · ${counts.pass} PASS · ${counts.passStar} PASS* · ${counts.blocked} BLOCKED · ${counts.partial} PARTIAL · ${counts.na} N/A · 65 POINTER.md folders generated`);
